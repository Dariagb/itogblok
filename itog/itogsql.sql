...
SELECT id, name, type_id, birthday, commands
FROM cats
...
INSERT INTO all_pets (name, type_id, birthday, commands)
SELECT name, 1 AS type_id, birthday, commands FROM cats;

INSERT INTO all_pets (name, type_id, birthday, commands)
SELECT name, 2 AS type_id, birthday, commands FROM dogs;

INSERT INTO all_pets (name, type_id, birthday, commands)
SELECT name, 3 AS type_id, birthday, commands FROM hamsters;

INSERT INTO all_pets (name, type_id, birthday, commands)
SELECT name, 4 AS type_id, birthday, commands FROM horses;

INSERT INTO all_pets (name, type_id, birthday, commands)
SELECT name, 5 AS type_id, birthday, commands FROM donkeys;